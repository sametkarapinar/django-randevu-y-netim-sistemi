...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
  ...
  jQuery('.sidebar-title').click(function () {
    jQuery('.sidebar-title').removeClass('active').find('div').replaceWith('');
    jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
    jQuery('.menu-content').slideUp('normal');

    if (jQuery(this).next().is(':hidden') == true) {
      jQuery(this).addClass('active');
      jQuery(this).find('div').replaceWith('<div class="according-menu-test"><i class="fa fa-angle-down"></i></div>');
  ...
  jQuery('.submenu-title').click(function () {
    jQuery('.submenu-title').removeClass('active').find('div').replaceWith('');
  ...
  $(".sidebar-wrapper nav ul>li a").filter(function () {
    ...
    if (link) {
      if (current.indexOf(link) != -1) {
        ...
        $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu-test"><i class="fa fa-angle-down"></i></div>');
        return false;
      }
    }
  });
  ...
  $(".sidebar-wrapper nav ul>li a").filter(function () {
    ...
    if (link) {
      if (current.indexOf(link) != -1) {
        ...
        $(this).addClass('active');
        $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu-test"><i class="fa fa-angle-down"></i></div>');
        $(this).parent().parent().parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu-test"><i class="fa fa-angle-down"></i></div>');
        return false;
      }
    }
  });
